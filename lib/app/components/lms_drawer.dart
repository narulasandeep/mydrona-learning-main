...
class LmsDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final storageController = Get.find<GetStorageService>();
    return Drawer(
      ...
      child: Column(
        ...
        children: [
          ListView(
            padding: EdgeInsets.only(top: 60.h, left: 46.w, right: 10.w, bottom: 10.h),
            ...
            children: [
              ListTile(
                ...
                title: Text("Tarun Chauhan", style: LmsTextUtil.textManrope20()),
                subtitle: Text("USER008", style: LmsTextUtil.textManrope12(color: Colors.white)),
              ),
