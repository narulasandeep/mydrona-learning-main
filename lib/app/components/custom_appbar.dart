import 'package:dronalms/app/appbarhelper/notify_controller.dart';
...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  CustomAppBar({Key? key, this.backgroundColor = Colors.white});
  ...
  Future showNotificationDialog({required BuildContext context}) {
  ...
  Widget _buildListTile({required BuildContext context}) {
